...
<?php
    $DonneesCV = array('Nom' => 'David',
                       ...
                       'Codec' => '141.80',
                       'Profession' => 'soldat d\'elite',
                       'Methode' => 'solitaire',
                       'Mission' => 'Engins Nucleaires',
                       'Passion' => 'me cacher dans des cartons',
                       'Hobbies' => 'Maniement des armes a feux');?>
...
<div class="infosperso">
    ...
    <img id="identpic" src="pics/pdp.jpg"></a>
     <!-- Information de contact du personnage -->
      <p>Nom de naissance: <em><?php echo$DonneesCV['Nom'];   ?></em></p>
      <p>Nom professionel: <em>Solid Snake</em></p>
      <p>Date de naissance: <em><?php echo$DonneesCV['date de naissance'];?></em></p>
      <p>Nationalite: <em><?php echo$DonneesCV['Nationalité'];?></em></p>
      <p>Codec: <em><?php echo$DonneesCV['Codec'];?></em></p>
...
<div class="presentation">
    ...
    <p>Bonjour, je suis <em>David</em> plus connu sous le nom de<br><em>Solid Snake</em> je suis un <?php echo$DonneesCV['Profession'];?> expert en infiltrations et en combats rapprochés.</p>
	<p>Surentrainé,je suis apte a remplir, en <?php echo$DonneesCV['Methode'];?>,des missions<br><strong>ultra-secretes</strong> et <strong>dangereuses</strong> en territoire ennemie.</p>
</p>
</div>
...
<div class="interest"> <!-- Centre d'interet -->
      ...
      <p>- Detruire des "<strong><?php echo$DonneesCV['Mission'];?></strong>" a mes heures perdues.</p>
      <p>- J'aime <?php echo$DonneesCV['Passion'];?>.</p>
      <p>- <?php echo$DonneesCV['Hobbies'];?>.</p>
</div>
</div>
</div>
